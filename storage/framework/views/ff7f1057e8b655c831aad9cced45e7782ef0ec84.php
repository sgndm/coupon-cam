...
<span class="pull-right" style="display: inline; margin-bottom: 5px;">
    ...
    <a href="<?php echo e(url('admin/stores/category/create')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Create</a>
...
<div class="col-sm-6">
    <form role="form" method="POST" action="<?php echo e(url('/admin/stores/category/update')); ?>">
    <?php echo e(csrf_field()); ?>

    <input type="hidden" name="formid" value="<?php echo e($storecategory->id); ?>" />
    <div class="form-group col-sm-6 <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
        <label for="name">Category Name</label>
        <input type="text" class="form-control" required="required" id="name" name="name" value="<?php echo e(old('name',$storecategory->category)); ?>" placeholder="Enter Name">
