...
<table id="example" class="display table table-striped" style="width: 100%; cellspacing: 0;">
    ...
    <tbody>
        ...
        <tr>
            <th><?php echo e($store->contact_name); ?></th>
            ...
            <th>
                ...
                <a href="<?php echo e(url('admin/stores/delete/'.$store->place_id)); ?>" onclick="return confirm('Are you sure want to delete ?')?true:false" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
            </th>
        </tr>
