                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:2%;">
                                                                <label class="btn-container">
                                                                    <input type="checkbox" value="<?php echo e($store->place_id); ?>" id="store<?php echo e($store->place_id); ?>" name="store_ids_1[]" onclick="get_store_details(<?php echo e($store->place_id); ?>);error_hide('promo_store_error_1');">
