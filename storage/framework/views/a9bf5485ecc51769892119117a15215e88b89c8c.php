      ...
      <div class="form-group col-sm-12">
          <label for="promo_lenght">Promo Lenght <small class="info-box-title">( in hours )</small></label>
           <select class="form-control" id="promo_lenght" name="promo_lenght" required>
             <?php for($n = 5; $n <= 55; $n += 5): ?>
             <option value="<?php echo e($n); ?>"> <?php echo e($n); ?> mins</option>
             <?php endfor; ?>
             <option value="<?php echo e(60); ?>"> 1 hour</option>
              <?php for($n = 2; $n <= 24; $n++): ?>
              <option value="<?php echo e($n * 60); ?>"> <?php echo e($n); ?> hours</option>
              <?php endfor; ?>
          </select>
      </div>
