    ...
    <div class="card">
        ...
        <div class="tab-content">
            <div class="tab-pane active p-20" id="tab-pane-1" role="tabpanel">
                <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('/user/promos/create_promo')); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <label class="btn-container">Outsid Store
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="form-group" style="display: block;">
                                        ...
                                        <button type="button" class="btn btn-primary col-md-8" style="margin:2px;" onclick="generate_qr_code(1);" id="crt_qr_1">Create QR Code</button>

                                        <a class="btn btn-primary col-md-8" style="margin:2px;" target="_blank" href="" id="print_code_1" >View Image</a>

                                        <button type="button" class="btn btn-primary col-md-8" style="margin:2px;" onclick="refresh_qr(1);" id="refresh_qr_1">Create New QR Code</button>
            ...
            <div class="tab-pane p-20" id="tab-pane-2" role="tabpanel">
                <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('/user/promos/update_promo')); ?>">
                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 store_p_container left_scroll" >
                                            <table class="category_table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:2%;">
                                                        <label class="btn-container">
                                                            <input type="checkbox"  value="<?php echo e($promo->promo_id); ?>" id="store<?php echo e($promo->promo_id); ?>" name="promos[]" onclick="get_promo_details(<?php echo e($promo->promo_id); ?>,2);" class="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                                </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="form-group"  style="display: block;">
                                        ...
                                        <button type="button" class="btn btn-primary col-md-8" style="margin:2px;" onclick="generate_qr_code(2);" id="crt_qr_2">Create QR Code</button>

                                        <a class="btn btn-primary col-md-8" style="margin:2px;" target="_blank" href="" id="print_code_2" >View Image</a>

                                        <button type="button" class="btn btn-primary col-md-8" style="margin:2px;" onclick="refresh_qr(2);" id="refresh_qr_2">Create New QR Code</button>
        ...
        function get_promo_details(promo_id,id){
            $.get("<?php echo e(url('user/get_promo_details')); ?>/"+parseInt(promo_id),function(data){
                ...
                if(data['status'] == 1){
                    ...
                    $('#qr_code_prev_'+id).attr('src',"<?php echo e(url('resources/assets/qr_codes')); ?>/"+promo['qr_image']);
