    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="tab-content">
                ...
                <?php endif; ?>
                    <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('/user/promos/create_promo')); ?>" id="promo_form_1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:2%;">
                                                                <label class="btn-container">
                                                                    <input type="checkbox" value="<?php echo e($store->place_id); ?>" id="store<?php echo e($store->place_id); ?>" class="checkstore" name="store_ids_1[]" onclick="get_store_details(<?php echo e($store->place_id); ?>);error_hide('promo_store_error_1');">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="promo_length" id="promo_length_1">
                                                <?php for($x = 1; $x <= 24; $x++): ?>
                                                    <option val="<?php echo e($x); ?>"><?php echo e($x); ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                ...
                <?php endif; ?>
                    <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('/user/promos/update_promo')); ?>" id="promo_form_2">
                        <?php echo e(csrf_field()); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 store_p_container left_scroll" >
                                                <table class="category_table">
                                                    <?php $__currentLoopData = $activePromos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>

                                                        <tr>
                                                            <td style="width:5%;">&nbsp;</td>
                                                            <td style="width:93%;"><?php echo e($promo->promo_name); ?></td>
                                                            <td style="width:2%;">
                                                                <label class="btn-container">
                                                                    <input type="checkbox"  value="<?php echo e($promo->promo_id); ?>" id="store<?php echo e($promo->promo_id); ?>" name="promos[]" onclick="get_promo_details(<?php echo e($promo->promo_id); ?>,2);error_hide('promo_store_error_2');" class="radio">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                            </td>
                                                        </tr>
                                                ...
                                                <table class="category_table">
                                                    <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $store): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:2%;">
                                                                <label class="btn-container">
                                                                    <input class="checkstore" type="checkbox" value="<?php echo e($store->place_id); ?>" id="store_2_<?php echo e($store->place_id); ?>" name="store_ids_2[]" onclick="set_last(<?php echo e($store->place_id); ?>);" >
                                                                    <span class="checkmark"></span>
                                                                    <input type="hidden" value="<?php echo e($store->latitude); ?>" id="store_lat_2_<?php echo e($store->place_id); ?>" name="store_lat_<?php echo e($store->place_id); ?>">
                                                                    <input type="hidden" value="<?php echo e($store->longitude); ?>" id="store_lng_2_<?php echo e($store->place_id); ?>" name="store_lng_<?php echo e($store->place_id); ?>">
                                                                    <input type="hidden" value="0" id="store_loc_2_<?php echo e($store->place_id); ?>" name="store_loc_<?php echo e($store->place_id); ?>">
                                                                </label>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                ...
                <div class="tab-pane p-20" id="tab-pane-3" role="tabpanel">
                    <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo e(url('/user/promos/delete_promo')); ?>">
                        <?php echo e(csrf_field()); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 store_p_container left_scroll" >
                                                <table class="category_table">
                                                    <?php $__currentLoopData = $puasedPromos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:2%;">
                                                                <label class="btn-container">
                                                                    <input type="checkbox"  value="<?php echo e($promo->promo_id); ?>" id="store<?php echo e($promo->promo_id); ?>" name="promos[]" onclick="get_promo_details(<?php echo e($promo->promo_id); ?>,3);" class="radio">
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 store_p_container left_scroll" >
                                            <table class="category_table">
                                                <?php $__currentLoopData = $finishedPromos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:2%;">
                                                            <label class="btn-container">
                                                                <input type="checkbox"  value="<?php echo e($promo->promo_id); ?>" id="store<?php echo e($promo->promo_id); ?>" name="promos[]" onclick="get_promo_details(<?php echo e($promo->promo_id); ?>,4);" class="radio">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </td>
                                                    </tr>
...
<?php $__env->startSection('custom_js'); ?>
    ...
    <script>
        var has_promos = <?php echo e($has_promos); ?>;
        var new_store = <?php echo e($new_store_id); ?>;
...
//            $('#refresh_qr_1').hide();
        ...
        function get_promo_details(promo_id,id){
            ...
            $.get("<?php echo e(url('user/get_promo_details')); ?>/"+parseInt(promo_id),function(data){
                 console.log(data);
            ...
            if(id == 4) {
                //alert("rerere");
                $.get("<?php echo e(url('user/get_final_promo_stats')); ?>/"+parseInt(promo_id),function(data){
                    // alert('success');
                    //  console.log(data);
        ...
        $('#search_promo').on('input', function(){
            ...
            if(input.length > 0) {
                $.get("<?php echo e(url('user/search_promos')); ?>/"+input,function(data){
                    $('#search_result').html('');
        ...
        function get_active_promos(){
            ...
            $.get("<?php echo e(url('user/get_active_promos')); ?>",function(data) {
        ...
        function get_inactice_promos(){
            ...
            $.get("<?php echo e(url('user/get_inactive_promos')); ?>",function(data) {
