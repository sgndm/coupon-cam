...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('resources/assets/custom/loader/css/modal-loading.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('resources/assets/custom/loader/css/modal-loading-animate.css')); ?>">
                    ...
                    <div class="row hidden-xs-down">
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <a href="<?php echo e(url('dashboard')); ?>">
                                <div class="card">
                                    <?php if(in_array(url()->current(),[url('dashboard')]) == true): ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/stat-w.png')); ?>" style="width: 100%;" >
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/stat-r.png')); ?>" style="width: 100%;" >
                                    <?php endif; ?>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <a href="<?php echo e(url('user/stores')); ?>">
                                <div class="card">
                                    <?php if(in_array(url()->current(),[url('user/stores/create'),url('user/stores'),url('user/stores/closed')]) == true): ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/store-w.png')); ?>" style="width: 100%;" >
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/store-r.png')); ?>" style="width: 100%;" >
                                    <?php endif; ?>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <a href="<?php echo e(url('user/promos')); ?>">
                                <div class="card">
                                    <?php if(in_array(url()->current(),[url('user/promos/create'),url('user/promos'),url('user/promos/closed')]) == true): ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/promos-w.png')); ?>" style="width: 100%;" >
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/promos-r.png')); ?>" style="width: 100%;" >
                                    <?php endif; ?>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <a href="<?php echo e(url('user/coupons')); ?>">
                                <div class="card">
                                    <?php if(in_array(url()->current(),[url('user/coupons/create'),url('user/coupons'),url('user/coupons/trash')]) == true): ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/coupons-w.png')); ?>" style="width: 100%;" >
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('resources/assets/custom/images/coupons-r.png')); ?>" style="width: 100%;" >
                                    <?php endif; ?>
                                </div>
                            </a>
                        </div>
...
<script src="<?php echo e(asset('resources/assets/custom/loader/js/modal-loading.js')); ?>"></script>

<script src="<?php echo e(asset('resources/assets/custom/js/cropit/jquery.cropit.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    function progressSpinnerTimer(text, time) {
        progressConfig = {
            direction: 'ver',
            discription: text,
            discriptionColor:  '#e80602',
    ...
    $(document).ready(function() {
        ...
        // create a spinner
        spinnerDefault = new Loading(defualtConfig);
