...
class selectWinner extends Command
{
    ...
    public function handle()
    {
      ...
      $rp_start = date('Y-m-d H:i:s', strtotime($get_rp[0]->start_date . " " . $get_rp[0]->start_at));
        ...
        if($diff_st->invert == 0) {
          ...
          // check remaining time
            ...
            if(sizeof($id_pool) > 0) {
              ...
              // create a log file
              $logFile = fopen("log_files/select_winner_log.txt", "a") or die("Unable to open file!");
          ...
          if($is_award_given == 1) {
            ...
            if($due_time == 1){
              ...
              if(sizeof($id_pool) > 0) {
                ...
                // create a log file
                $logFile = fopen("log_files/select_winner_log.txt", "a") or die("Unable to open file!");
                $content = "Selected a new winner  at : " . $get_now . " | winner is : " . $winner ."\n";
                fwrite($logFile, $content);
        		    fclose($logFile);
              }
