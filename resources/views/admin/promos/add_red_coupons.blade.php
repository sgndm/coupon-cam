...
<form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/admin/red_promos/save') }}">
  {{ csrf_field() }}
...
<script type="text/javascript">
  ...
  function get_stores() {
    ...
    if(promo_id > 0) {
      ...
      $.get("{{ url('admin/red_promos/get_stores') }}/"+promo_id,function(data){
  ...
  function get_coupons() {
    ...
    if((store_id > 0) && (promo_id > 0)) {
      ...
      $.get("{{ url('admin/red_promos/get_coupons') }}/"+promo_id+"/"+store_id,function(data){
  ...
  function add_to_promo(coupon_id) {
    ...
    if( (promo_id > 0) && (store_id > 0) && (coupon_id > 0) ){
      // add to data base
      $.get("{{ url('admin/red_promos/save_coupon') }}/"+promo_id+"/"+store_id+"/"+coupon_id,function(data){
  ...
  function remove_from_promo(coupon_id) {
    ...
    if( (promo_id > 0) && (coupon_id > 0) ){
      // add to data base
      $.get("{{ url('admin/red_promos/remove_coupon') }}/"+promo_id+"/"+coupon_id,function(data){
