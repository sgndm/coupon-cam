    ...
    <div class="card">
        <ul class="nav nav-tabs customtab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-pane-2" role="tab" onclick="open_tab();">
                    <span class="hidden-sm-up"><i class="ti-user"></i></span>
                    <span class="hidden-xs-down">OPEN STORES</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-pane-3" role="tab" onclick="cloased_tab();">
                    <span class="hidden-sm-up"><i class="ti-email"></i></span>
                    <span class="hidden-xs-down">CLOSED STOERES</span>
                </a>
            </li>
            <li class="nav-item">
            </li>
        ...
        <div class="tab-content">
            <div class="tab-pane active p-20" id="tab-pane-1" role="tabpanel">
                <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/user/stores/create_store') }}">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="form-group">
                                    <label class="control-label col-md-12 col-lg-12">Enter Full Address</label>
                                    <input type="text" id="street_num_2" name="street_num" class="form-control col-sm-12 col-md-3 col-lg-3" placeholder="Number" required>
        ...
        function get_store_details(store_id, id){
            ...
            $.get("{{ url('user/get_store_details') }}/"+parseInt(store_id),function(data){
                ...
                if(data['status'] == 1){
                    ...
                    if(id == 2) {
                      $('#store_marker_hidden_2').val(store[0]['store_marker']);
                    }
