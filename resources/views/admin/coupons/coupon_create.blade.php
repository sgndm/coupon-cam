...
@section('content')
<form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/admin/coupons/save') }}">
        {{ csrf_field() }}
<div class="col-sm-6">
        ...
        <div class="form-group col-sm-12 {{ $errors->has('company_name') ? ' has-error' : '' }}">
            ...
            <select class="form-control" id="company_name" required="required" onchange="promos()" name="company_name">
                ...
                <option value="{{ $user->id }}" @if(old('company_name') == $user->id) selected="selected" @endif >{{ $user->name }}</option>
                @endforeach
            </select>
            ...
            <div class="tab-content" style="min-height:756px;">
             <div role="tabpanel" class="tab-pane active" id="step_1">
                        <div class="form-group col-sm-12 {{ $errors->has('coupon_name_1') ? ' has-error' : '' }}">
                            ...
                            <input type="text" onkeyup="setheading('1');" required="required" maxlength="30" class="form-control" id="coupon_name_1" name="coupon_name_1" value="{{ old('coupon_name_1') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('availablity_1') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="required" maxlength="30" class="form-control" id="availablity_1" name="availablity_1" value="{{ old('availablity_1') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('term_condition_1') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="term_condition_1" name="term_condition_1">{{ old('term_condition_1') }}</textarea>
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('expiery_date_1') ? ' has-error' : '' }}" style="display: none;">
                            <label for="expiery_date_1">Expiry Date</label>
                            <input type="text" class="form-control date-picker" id="expiery_date_1" name="expiery_date_1" value="{{ old('expiery_date_1') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('estimated_value_1') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="estimated_value_1" name="estimated_value_1" value="{{ old('estimated_value_1') }}">
                ...
                <div role="tabpanel" class="tab-pane" id="step_2">
                        <div class="form-group col-sm-12 {{ $errors->has('coupon_name_2') ? ' has-error' : '' }}">
                            ...
                            <input type="text" onkeyup="setheading('2');" required="required" maxlength="30" class="form-control" id="coupon_name_2" name="coupon_name_2" value="{{ old('coupon_name_2') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('availablity_2') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="required" maxlength="30" class="form-control" id="availablity_2" name="availablity_2" value="{{ old('availablity_2') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('term_condition_2') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="term_condition_2" name="term_condition_2">{{ old('term_condition_2') }}</textarea>
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('expiery_date_2') ? ' has-error' : '' }}" style="display: none;">
                            <label for="expiery_date_2">Expiry Date</label>
                            <input type="text" class="form-control date-picker" id="expiery_date_2" name="expiery_date_2" value="{{ old('expiery_date_2') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('estimated_value_2') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="estimated_value_2" name="estimated_value_2" value="{{ old('estimated_value_2') }}">
             ...
             <div role="tabpanel" class="tab-pane" id="step_3">
                        <div class="form-group col-sm-12 {{ $errors->has('coupon_name_3') ? ' has-error' : '' }}">
                            ...
                            <input type="text" onkeyup="setheading('3');" required="required" maxlength="30" class="form-control" id="coupon_name_3" name="coupon_name_3" value="{{ old('coupon_name_3') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('availablity_3') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="required" maxlength="30" class="form-control" id="availablity_3" name="availablity_3" value="{{ old('availablity_3') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('term_condition_1') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="term_condition_3" name="term_condition_3">{{ old('term_condition_3') }}</textarea>
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('expiery_date_3') ? ' has-error' : '' }}" style="display: none;">
                            <label for="expiery_date_3">Expiry Date</label>
                            <input type="text" class="form-control date-picker" id="expiery_date_3" name="expiery_date_3" value="{{ old('expiery_date_3') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('estimated_value_3') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="estimated_value_2" name="estimated_value_3" value="{{ old('estimated_value_3') }}">
             ...
             <div role="tabpanel" class="tab-pane" id="step_4">
                        <div class="form-group col-sm-12 {{ $errors->has('coupon_name_4') ? ' has-error' : '' }}">
                            ...
                            <input type="text" onkeyup="setheading('4');" required="required" maxlength="30" class="form-control" id="coupon_name_4" name="coupon_name_4" value="{{ old('coupon_name_4') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('availablity_4') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="required" maxlength="30" class="form-control" id="availablity_4" name="availablity_4" value="{{ old('availablity_4') }}">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('term_condition_4') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="term_condition_4" name="term_condition_4">{{ old('term_condition_4') }}</textarea>
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('expiery_date_4') ? ' has-error' : '' }}" style="display: none;">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('estimated_value_4') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="estimated_value_4" name="estimated_value_4" value="{{ old('estimated_value_4') }}">
...
<div class="col-sm-6">
    <div class="imagecontainer">
        ...
        <div class="content" id="content_1">
            ...
            <img id="image_1" src="{{ asset('resources/assets/user/images/imageplaceholder.png') }}">
        </div>
        
        <div class="heading" id="heading_2"></div>
        <div class="content" id="content_2">
            <div class="goimage"></div>
            <img id="image_2" src="{{ asset('resources/assets/user/images/imageplaceholder.png') }}">
        </div>
        
        <div class="heading" id="heading_3"></div>
        <div class="content" id="content_3">
            <div class="goimage"></div>
            <img id="image_3" src="{{ asset('resources/assets/user/images/imageplaceholder.png') }}">
        </div>
        
        <div class="heading" id="heading_4"></div>
        <div class="content" id="content_4">
            <div class="goimage"></div>
            <img id="image_4" src="{{ asset('resources/assets/user/images/imageplaceholder.png') }}">
        </div>
    </div>
</div>
        </form>
