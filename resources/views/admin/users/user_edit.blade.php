...
<form role="form" method="POST" action="{{ url('/admin/users/update') }}">
    ...
    <div class="form-group col-sm-6 {{ $errors->has('contact_details') ? ' has-error' : '' }}">
        ...
        <input type="text" class="form-control" id="contact_details" name="contact_details" value="{{ old('contact_details',$user->contact) }}" placeholder="Phone Number">
    ...
    <div class="form-group col-sm-6 {{ $errors->has('usertype') ? ' has-error' : '' }}">
        ...
        <select class="form-control" id="usertype" name="usertype">
            <option value="1" @if(old('usertype',$user->usertype) == 1) selected="selected" @endif>User</option>
            <option value="0" @if(old('usertype',$user->usertype) == 0) selected="selected" @endif>Administrator</option>            
        </select>
    ...
    <div class="form-group col-sm-6 {{ $errors->has('address') ? ' has-error' : '' }}">
        ...
        <input type="text" class="form-control" id="address" name="address" value="{{ old('address',$user->address) }}" placeholder="Street Address">
	...
	<div class="form-group col-sm-6 {{ $errors->has('address') ? ' has-error' : '' }}">
        <label for="address">Street Address</label>
        <input type="text" class="form-control" id="address_address" name="address_address" value="{{ old('address_address',$user->address) }}" placeholder="Street Address">
        @if ($errors->has('address'))
        <span class="help-block"><strong>{{ $errors->first('address') }}</strong></span>
        @endif
    </div>
    ...
    <div class="form-group col-sm-6 {{ $errors->has('zip_code') ? ' has-error' : '' }}">
        ...
        <input type="text" class="form-control" id="zip_code" name="zip_code" value="{{ old('zip_code',$user->zip_code) }}" placeholder="Postal / Zip Code">
    ...
    <div class="form-group col-sm-6 {{ $errors->has('state') ? ' has-error' : '' }}">
        ...
        <input type="text" class="form-control" id="state" name="state" value="{{ old('state',$user->state) }}" placeholder="State">
        @if ($errors->has('state'))
    ...
    <div class="form-group col-sm-6">
        ...
        <input type="text" class="form-control" readonly="" id="aaa" name="aaa" value="{{ $user->xpass }}">
        @if ($errors->has('password'))
        <span class="help-block"><strong>{{ $errors->first('password') }}</strong></span>
        @endif
    </div>
    <div class="form-group col-sm-6 {{ $errors->has('password') ? ' has-error' : '' }}" style="display: none;">
        <label for="password">Password</label>
        <input type="password" class="form-control" id="password" value="{{ $user->xpass }}" name="password" placeholder="Password">
        @if ($errors->has('password'))
        <span class="help-block"><strong>{{ $errors->first('password') }}</strong></span>
        @endif
    </div>
    <div class="form-group col-sm-6 {{ $errors->has('password_confirmation') ? ' has-error' : '' }}" style="display: none;">
        <label for="confirm_password">Confirm Password</label>
        <input type="password" class="form-control" id="password_confirmation" value="{{ $user->xpass }}" name="password_confirmation" placeholder="Password">
