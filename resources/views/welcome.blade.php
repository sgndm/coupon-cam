...
<div style="text-align:center; padding: 10px 0 0px 0;">
                <img src="{{ url('resources/assets/user/images/Coupon-GO-Logo-Vector.png') }}" style="height:100px; width: auto;">
            </div>
  ...
  <div class="form">
    <form class="login-form">
      <button type="button" onclick="return window.location='{{ url('login') }}'">Let's Go</button>
     </form>
  </div>
</div>
            </div>
