...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('resources/assets/custom/loader/css/modal-loading.css') }}">
    <link rel="stylesheet" href="{{ asset('resources/assets/custom/loader/css/modal-loading-animate.css') }}">
...
<script src="{{ asset('resources/assets/custom/loader/js/modal-loading.js') }}"></script>
