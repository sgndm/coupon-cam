                    ...
                    <div class="col-md-12 align-self-center">
                        ...
                        <div class="row hidden-xs-down">
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <a href="{{ url('user/profile') }}">
                                    <div class="card">
                                        @if(in_array(url()->current(),[url('user/profile'),url('settings')]) == true)
                                            <img src="{{ asset('resources/assets/custom/images/business-w.png') }}" style="width: 100%;" >
                                        @else
                                            <img src="{{ asset('resources/assets/custom/images/business-r.png') }}" style="width: 100%;" >
                                        @endif
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <a href="{{ url('user/team') }}">
                                    <div class="card">
                                        @if(in_array(url()->current(),[url('user/team')]) == true)
                                            <img src="{{ asset('resources/assets/custom/images/team-w.png') }}" style="width: 100%;" >
                                        @else
                                            <img src="{{ asset('resources/assets/custom/images/team-r.png') }}" style="width: 100%;" >
                                        @endif
                                    </div>
                                </a>
                            </div>
