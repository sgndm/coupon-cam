            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    <ul class="menu accordion-menu">
                      ...
                      <li class="droplink @if(in_array(url()->current(),[url('admin/give_away/stores')]) == true) active @endif"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-gift"></span><p>Give Away </p></a>
                          <ul class="sub-menu">
